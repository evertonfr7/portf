  ...
  return (
    <html lang="pt-BR" className="dark" suppressHydrationWarning>
      ...
      >
        ...
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-YNW9TN0T8H"
          strategy="afterInteractive"
        />
        <Script id="google-analytics" strategy="afterInteractive">
          {`window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-YNW9TN0T8H');`}
        </Script>
      </body>
    </html>
  );
